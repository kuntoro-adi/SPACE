...
class SPACE(nn.Module):
    ...
    def __init__(self, low_res=384, apply_center_bias=True, apply_gfcorrection=False, apply_len=False):
        ...
        self.Block1 = nn.Conv2d(1, 16, (3,3), padding=1, stride=2)
        self.Block2 = Inverted_Residual(16,24,16)
        self.Block3 = Inverted_Residual(16,32,24)
        self.Block4a = Inverted_Residual(24,40,32) if not self.use_center_bias else Inverted_Residual(26,40,32)
        self.Block4b = Inverted_Residual(32,48,32,filter_size=5)
        self.Block5a = Inverted_Residual(32,64,48,filter_size=5)
        self.Block5b = Inverted_Residual(48,96,48,filter_size=5)
        ...
        self.final_fuse = nn.Conv2d(out_feature_final, 1, (1,1), padding=0)
        
        self.power_mlp = MultilayerPerceptron(3, 16, self.final_fuse.in_channels)
    ...
    def forward(self, x_luminance, R : float = 0.81):
        ...
        x_luminance = self.final_fuse(x_luminance)
